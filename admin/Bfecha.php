...
if ($_POST['submit'] == "Eliminar") {
  ...
  // Si todos esta bien vamos a borrar el registro 
  	...
  	$QB_selectEL='SELECT id_evento FROM evento_ocupa WHERE id_fecha='.$idfecha.' GROUP BY id_evento';
	// Debug
	// print $QB_selectEL;
	// retorno();
	...
	$QB_evento_ocupa=  "DELETE FROM evento_ocupa WHERE id_fecha="."'".$idfecha."'";
	// Debug
	...
	*/
	...
	// Finalmente la fecha 
  	$QB_lugar= "DELETE FROM fecha_evento WHERE id="."'".$idfecha."'";
...
// o para corregir datos que ya hayamos tratado de introducir
	...
	imprime_valoresOk($idfecha,$REQUEST_URI);
	print'<center>
